...
var AlgorithmsForResearchAssistants = require('../lib/AlgorithmsForResearchAssistants.js');
/*
...
describe("lib/AlgorithmsForResearchAssistants", function() {

  it("should load", function() {
    expect(AlgorithmsForResearchAssistants.init()).toBe("init");
  });
